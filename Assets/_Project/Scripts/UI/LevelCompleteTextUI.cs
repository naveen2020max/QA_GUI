...
public class LevelCompleteTextUI : MonoBehaviour
{
    ...
    [SerializeField] private string mainMenuSceneName = "MainMenu"; // Configure in inspector
    ...
    void Awake()
    {
        ...
        if (problemMaster == null)
        {
            ...
            problemMaster = FindFirstObjectByType<TextProblemMaster>();
            if (problemMaster == null)
            {
    ...
    [ContextMenu("Test Level Complete UI")]
    private void HandleLevelComplete()
    {
        ...
        // Populate the UI
        PopulateUI(results);
        Debug.Log("levelComplete function ui");
